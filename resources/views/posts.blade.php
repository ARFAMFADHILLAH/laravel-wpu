...
@section('container')
{{-- <h1 class="mb-5">Post Category : {{ $posts->name }} </h1> --}}
...
<div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
          ...
          class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/blog?category={{ $posts[0]->category->slug }}" class="text-decoration-none"> {{ $posts[0]
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="position-absolute  px-3 py-2" style="background-color:rgba(0, 0, 0, 0.7)"><a href="/
                    posts?category={{ $post->category->slug }}" class= "text-white text-decoration-none ">{{ $post->category->name }}</a></div>
